...
document.getElementById('tier-picker-common-m').addEventListener('click', () => {
      ...
      document.getElementById('mint-price-0-m').innerHTML = 500
      setTotalPriceM()
})
...
document.getElementById('tier-picker-rare-m').addEventListener('click', () => {
      ...
      document.getElementById('mint-price-0-m').innerHTML = 1000
      setTotalPriceM()
})
...
document.getElementById('tier-picker-epic-m').addEventListener('click', () => {
      ...
      document.getElementById('mint-price-0-m').innerHTML = 2000
      setTotalPriceM()
})
...
document.getElementById('tier-picker-leg-m').addEventListener('click', () => {
      ...
      document.getElementById('mint-price-0-m').innerHTML = 4000
      setTotalPriceM()
})
